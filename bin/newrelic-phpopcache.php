    ...
    private function gather_metrics() {
      ...
      $this->metrics = array(
          ...
          'components' => array( array(
			  ...
			  'Component/PHPOPcache/Configuration/Directives/opcache.dups_fix[boolean]' => $opcache_conf['directives']['opcache.dups_fix'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.revalidate_path[boolean]' => $opcache_conf['directives']['opcache.revalidate_path'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.log_verbosity_level[level]' => $opcache_conf['directives']['opcache.log_verbosity_level'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.memory_consumption[bytes]' => $opcache_conf['directives']['opcache.memory_consumption'],
			  'Component/PHPOPcache/Configuration/Directives/interned_strings_buffer[megabytes]' => $opcache_conf['directives']['opcache.interned_strings_buffer'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.max_accelerated_files[files]' => $opcache_conf['directives']['opcache.max_accelerated_files'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.max_wasted_percentage[percent]' => $opcache_conf['directives']['opcache.max_wasted_percentage'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.consistency_checks[Nrequests]' => $opcache_conf['directives']['opcache.consistency_checks'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.force_restart_timeout[seconds]' => $opcache_conf['directives']['opcache.force_restart_timeout'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.revalidate_freq[seconds]' => $opcache_conf['directives']['opcache.revalidate_freq'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.preferred_memory_model[string]' => $opcache_conf['directives']['opcache.preferred_memory_model'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.blacklist_filename[string]' => $opcache_conf['directives']['opcache.blacklist_filename'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.max_file_size[bytes]' => $opcache_conf['directives']['opcache.max_file_size'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.error_log[string]' => $opcache_conf['directives']['opcache.error_log'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.protect_memory[boolean]' => $opcache_conf['directives']['opcache.protect_memory'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.save_comments[boolean]' => $opcache_conf['directives']['opcache.save_comments'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.load_comments[boolean]' => $opcache_conf['directives']['opcache.load_comments'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.fast_shutdown[boolean]' => $opcache_conf['directives']['opcache.fast_shutdown'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.enable_file_override[boolean]' => $opcache_conf['directives']['opcache.enable_file_override'],
			  'Component/PHPOPcache/Configuration/Directives/opcache.optimization_level[integer]' => $opcache_conf['directives']['opcache.optimization_level'],
			  'Component/PHPOPcache/Version[version]' => $opcache_conf['version']['version'],
                  )
          ))
        );
